...
var firstWordLenght = exampleFirstWord4.length;
var secondWordLenght = secondWord4.length;
var thirdWordLenght = thirdWord4.length;
var fourthWordLenght = fourthWord4.length;
var fifthWordLenght = fifthWord4.length;


console.log('First Word: ' +exampleFirstWord4 +', with length: '+firstWordLenght);
